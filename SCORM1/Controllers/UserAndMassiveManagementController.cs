    ...
    public class UserAndMassiveManagementController : Controller
    {
        ...
        private void SendEmail(string NameUser, string Email, string Usuario, string Company)
        {
            try
            {
                ...
                "<br/>" + "<a href='https://aprendeyavanza2.com.co/CompetenciasEstrategicas'><button style='background: #CC023B; color: #fff; padding: 10px; font-size: 20px; border-radius: 13px;'>Ingresa Aqu&igrave;</button></a>" +
                "" + "<br/>" +
